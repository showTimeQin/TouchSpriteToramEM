...
--日志函数
function emLog(content)
	log(content, os.date("%Y年%m月%d日%H点",getNetTime()))
end
...
function moveToDN(n)
	...
	for i=1, 4 do
		...
		touchMove(1131,  100);    --移动到坐标 ，注意一次滑动的坐标间隔不要太大，不宜超过 50 像素
		mSleep(1000);
...
function goToCity(n)
	if n == 0 then	-- 0使用第一格机票
		touch(26,   58, 0x167bc5, 95) -- 点击选单
		nLog("点击选单")
		mSleep(1000)
		touch(188,  360, 0x4a2c07, 95) -- 点击道具
		mSleep(1000)
		touch(294,  223, 0x39b3c0, 95) -- 点击重排
		mSleep(1000)
		touch(785,  625, 0x1b84ff,95) -- 确认
		mSleep(1000)
		touch(796,  163, 0x58572b, 95)  -- 飞机票
		mSleep(1000)
		touch(101,  216, 0xedd88d, 95) -- 使用
		mSleep(1000)
		touch(785,  625, 0x1b84ff,95) -- 确认
		mSleep(1000)
	end
